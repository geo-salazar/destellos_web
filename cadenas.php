...
// 2. Consultamos los productos de la categoría 'Cadenas'
try {
    ...
    <div class="cards-container">
        ...
        <?php else: ?>
            <?php foreach ($productos as $producto): ?>
                <article class="card">
                    <img src="<?= htmlspecialchars($producto['imagen_url'] ?? 'img/cadena.svg') ?>" 
                    ...
                    <div class="card-content">
                        ...
                        <!-- Corrección de typo en JS y uso de datos de BD -->
                        <button onclick="addToCart('<?= htmlspecialchars($producto['nombre']) ?>', <?= $producto['precio'] ?>, '<?= htmlspecialchars($producto['imagen_url'] ?? 'img/cadena.svg') ?>')">
                            Agregar al carrito
                        </button>
                    </div>
                </article>
