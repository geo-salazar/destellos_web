...
<section class="products-section">
    ...
    <div class="card-content">
        <h3>Aretes Luna</h3>
        <p class="description">Aretes pequeños y luminosos. perfectos para uso diario.</p>
        <p class="price">₡9.500</p>
        <button onclick="addToCart('Aretes Luna', 9500, 'img/aretes.svg')">Agregar al carrito</button>
    </div>
</article>
<article class="card">
    <img src="img/aretes.svg" alt="Aretes Perla Rosa">
    <div class="card-content">
        <h3>Aretes Perla Rosa</h3>
        <p class="description">Diseño romántico con acabado delicado y elegante.</p>
        <p class="price">₡11.900</p>
        <button onclick="addToCart('Aretes Perla Rosa', 11900, 'img/aretes.svg')">Agregar al carrito</button>
    </div>
</article>
<article class="card">
    <img src="img/aretes.svg" alt="Aretes Estrella">
    <div class="card-content">
        <h3>Aretes Estrella</h3>
        <p class="description">Un toque juvenil y brillante para resaltar tu rostro.</p>
        <p class="price">₡8.900</p>
        <button onclick="addToCart('Aretes Estrella', 8900, 'img/aretes.svg')">Agregar al carrito</button>
    </div>
</article>
