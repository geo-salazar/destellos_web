...
// 2. Consultamos los productos de la categoría 'Collar'
try {
...
<link href="https://fonts.googleapis.com/css2?family=Great+Vibes&family=Playfair+Display:wght@400;600;700&family=Poppins:wght@300;400;500;600&display=swap" rel="stylesheet">
    ...
    <title>Collares | Destellos</title>
</head>
<body>
        ...
        <section class="page-banner">
            <div>
                ...
                <div style="display: flex; align-items: baseline; gap: 25px;">
                    <h2 class="section-title">Collares</h2>
                    <p>Detalles elegantes para acompañar tu escote.</p>
                </div>
            </div>
        </section>
                ...
                <div class="cards-container">
                    ...
                    <?php else: ?>
                        <?php foreach ($productos as $producto): ?>
                            <article class="card">
                                <img src="<?= htmlspecialchars($producto['imagen_url'] ?? 'img/collar1.webp') ?>" 
                                ...
                                <div class="card-content">
                                    ...
                                    <button onclick="addToCart('<?= htmlspecialchars($producto['nombre']) ?>', <?= $producto['precio'] ?>, '<?= htmlspecialchars($producto['imagen_url'] ?? 'img/collar.svg') ?>')">
                                        Agregar al carrito
                                    </button>
                                </div>
                            </article>
